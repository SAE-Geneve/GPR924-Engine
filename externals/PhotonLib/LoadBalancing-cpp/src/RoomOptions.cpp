...
namespace ExitGames
{
	namespace LoadBalancing
	{
		...
		/**
		   ...
		   Client::opJoinRandomRoom() and Client::opJoinRandomOrCreateRoom() only use those rooms for matchmaking that are assigned to the lobby in which it is told to be looking for rooms.
		   ...
		   @note
		   This option gets ignored by Client::opJoinRandomOrCreateRoom(), which will always create the room in the same lobby, that was told to use when looking for an existing room.
		   @remarks
