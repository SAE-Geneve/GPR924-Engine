...
concept is_resource_destructible = requires(DestructorT destructor, ResourceT resource)
{
...
class Resource
{
  static_assert(is_resource_destructible<Destructor, T>, "Resource requires a Destructor type");
public:
  Resource() = default;
